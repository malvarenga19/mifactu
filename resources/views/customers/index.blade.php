    ...
    <div id="delete-modal" style="display:none;">
        <div class="modal-overlay" onclick="closeModal()">
            <div class="modal-content" onclick="event.stopPropagation()">
                ...
                <p id="delete-modal-message">¿Eliminar este cliente?<br><small style="color:var(--danger)">Esta acción no se
                        puede deshacer.</small></p>
...
@push('scripts')
    <script>
            ...
            tbody.innerHTML = customers.map(customer => {
                ...
                <tr>
                    ...
                    <td style="display: flex; gap: 0.3rem;">
                        ...
                        <button type="button" class="btn btn-sm btn-danger" style="padding:0.2rem 0.5rem;" onclick="confirmDelete(${customer.id}, '${escapeHtml(customer.name).replace(/'/g, "\\'")}')">🗑️</button>
                    </td>
                </tr>
            `;
            }).join('');
        ...
        function confirmDelete(id, name) {
            ...
            message.innerHTML = `¿Eliminar el cliente <strong>${escapeHtml(name)}</strong>?<br><small style="color:var(--danger)">Esta acción no se puede deshacer.</small>`;
